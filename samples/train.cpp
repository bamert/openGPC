...
int main(int argc, char** argv) {
    ...
    if (argc == 3) {
        ...
        cout << "Usage: " << argv[0]
             << " <extracted dataset path> <forest path>" << endl;
    ...
    gpc::training::OptimizerSettings zerooptimizer =
        gpc::training::ZeroOptimizerSettings()
            .builder()
            .numResamples(10)
    ...
    // weight recall and precision equally (0.5)
    gpc::training::OptimizerSettings tauoptimizer =
        gpc::training::TauOptimizerSettings()
            .builder()
            .taulo(-10)
            .tauhi(10)
            .numResamples(10)
    ...
    gpc::training::ForestSettings forestsettings(
        gpc::training::FernFactory(2, 2, 2, 5), 0.7);
    ...
    gpcforest.trainAndExport(
        trainingData, forestsettings, zerooptimizer, forestPath);
}
